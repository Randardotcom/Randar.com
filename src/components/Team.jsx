    ...
    <div className="bg-transparent min-h-screen font-sans">
      ...
      <section className="pt-40 pb-20 px-6 md:px-12 max-w-7xl mx-auto text-center relative z-10">
        ...
        <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
          We aren't just an agency; we are an engineering and design collective.
          Scroll down to meet the architects behind Randar.
        </p>
      </section>
      ...
      <section
        ref={sectionRef}
        className="h-screen w-full relative overflow-hidden flex items-center justify-center bg-transparent"
      >
        {/* --- 3D Theme Spheres --- */}
        ...
        <div className="relative w-full max-w-md h-[500px] z-10 mx-6">
          {team.map((member, index) => (
            ...
            >
              ...
              <p className="text-[#2563eb] font-semibold uppercase tracking-widest text-sm mb-6">
                {member.role}
              </p>
